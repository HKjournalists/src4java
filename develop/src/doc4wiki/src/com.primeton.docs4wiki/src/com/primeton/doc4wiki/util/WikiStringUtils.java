/*******************************************************************************
 * $Header: /cvsroot/BPS6/develop/build/dailybuild/doc4wiki/src/com.primeton.docs4wiki/src/com/primeton/doc4wiki/util/WikiStringUtils.java,v 1.1 2013/06/06 01:44:58 liuxiang Exp $
 * $Revision: 1.1 $
...
public class WikiStringUtils {
    ...
    public static boolean isNotEmpty(String str) {
        return !WikiStringUtils.isEmpty(str);
    }
    ...
    public static boolean isNotBlank(String str) {
        return !WikiStringUtils.isBlank(str);
    }
 ...
 /**
    ...
    public static int indexOfAny(String str, char[] searchChars) {
        if (isEmpty(str) || searchChars == null || searchChars.length < 1) {
            return -1;
        }
     ...
     * </pre>
     *
     * @see WikiStringUtils#defaultString(String, String)
     * @param str  the String to check, may be null
     * @param defaultStr  the default String to return
    ...
    public static String defaultIfEmpty(String str, String defaultStr) {
        return WikiStringUtils.isEmpty(str) ? defaultStr : str;
    }
